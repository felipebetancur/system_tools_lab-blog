...
# Content
  ...
  - [✏️ A brief overview and why write eBPF programs using C?](#overview_ebpf_c_language)
  - [🧩 Essential components of eBPF](#ebpf_components)
    - [Attachment Points (Hooks) and eBPF Program Types](#hooks)
    - [Helper Functions](#helper_functions)
    - [eBPF Maps](#eBPF_Maps)
  - [📜 libbpf and bpftool](#libbpf_bpftool)
  - [🇨 First eBPF Program in C](#first_ebpf_with_c)
  - [🧑‍💻 Practical Example of eBPF in C](#practical_example_ebpf_with_c)
  - [✅ Use Cases](#use_cases)
  - [✨ Conclusion](#conclusion)
  - [📚 Bibliography and Recommended Resources](#bibliography)
...
<h2 id="overview_ebpf_c_language">✏️ A brief overview and why write eBPF programs using C?</h2>
...
<h2 id="ebpf_components">🧩 Essential components of eBPF</h2>
...
<h2 id="libbpf_bpftool">📜 libbpf and bpftool</h2>
...
<h2 id="first_ebpf_with_c">🇨 First eBPF Program in C</h2>
...
```
💡 The compiler option *-D__TARGET_ARG_xxx* allows cross-compilation, for example to use eBPF in embedded systems.
...
<h2 id="practical_example_ebpf_with_c">🧑‍💻 Practical Example of eBPF in C</h2>
...
<h2 id="bibliography">📚 Bibliography and Recommended Resources</h2>
